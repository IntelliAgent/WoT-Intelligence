package ca.intelliagent.common.swapper;
/*
...
public final class ByteSwapper {
    ...
    /**
     * Reverses the bits of a byte by promoting it to an int and reversing that,
     * and then shifting to the right by the appropriate distance, and finally casting
     * it back to byte.
     *
     * @param by
     */
    public static byte swap(byte by) {
        return (byte) (Integer.reverse(by) >>> (Integer.SIZE - Byte.SIZE));
    }
}
